  ...
  return (
    <div className="w-full max-w-[800px] mx-auto pt-10">
      <div className="flex justify-between items-center bg-white rounded-2xl rounded-b-none px-8 py-5">
        ...
        <button className="bg-green-600 px-4 py-2 rounded-md text-white flex justify-center items-center">
          <svg xmlns="http://www.w3.org/2000/svg" width="25px" height="25px" viewBox="0 0 24 24" fill="none">
          <path d="M7 12L12 12M12 12L17 12M12 12V7M12 12L12 17" stroke="#ffffff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
          <span className="inline-block pr-1 bg-green-600">Add Task</span>
        </button>
      </div>
      <div className="mt-5 bg-white rounded-2xl rounded-t-none p-5">
        <p className="text-center pt-5 text-lg text-gray-400 font-medium">Task list is empty <button className="underline text-green-600 text-base px-1">Add Task</button></p>
